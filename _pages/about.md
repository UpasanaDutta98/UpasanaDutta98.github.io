...
This past summer I interned at [Microsoft](https://www.microsoft.com/en-us/microsoft-365-copilot) as an Applied Scientist Intern with the Copilot Notebooks Team, where I built LLM-as-a-judge evaluation frameworks to characterize the strengths and failure modes of Copilot Notebooks and benchmark it against Google's NotebookLM. In summer 2025, I also intered at [Meta](https://www.meta.com/) as a Machine Learning SWE Intern with the Profile Relevance Team (Facebook), where I trained models to rank Facebook friend lists and improve user experience for 3 billion Facebook users.
